 ...
 * schema and documents for these {@link InternalVisibilityConfig} and has its own package and
 * database so that its data doesn't interfere with any clients' data. It persists the document and
 * schema through AppSearchImpl.
 *
...
public class VisibilityStore {
    ...
    private VisibilityStore(
        ...
        GetSchemaResponse getSchemaResponse =
                getVisibilitySchemaResponse(mDatabaseName, callStatsBuilder);
    ...
    /**
     * Sets visibility settings for the given {@link InternalVisibilityConfig}s. Any previous {@link
     * InternalVisibilityConfig}s with same prefixed schema type will be overwritten.
     *
    ...
    public void setVisibility(
            @NonNull List<InternalVisibilityConfig> prefixedVisibilityConfigs,
            CallStats.@Nullable Builder callStatsBuilder)
            throws AppSearchException {
    ...
    public void removeVisibility(
            @NonNull Set<String> prefixedSchemaTypes, CallStats.@Nullable Builder callStatsBuilder)
            throws AppSearchException {
                ...
                try {
                    ...
                    if (e.getResultCode() == RESULT_NOT_FOUND) {
                        ...
                        if (LogUtil.DEBUG) {
                            Log.d(
                                    TAG,
                                    "Cannot find Android V overlay document for "
                                            + prefixedSchemaType
                                            + " to remove.");
                        }
                    } else {
    ...
    @NonNull
    private GetSchemaResponse getVisibilitySchemaResponse(
            @NonNull String databaseName, CallStats.@Nullable Builder callStatsBuilder)
            throws AppSearchException {
        GetSchemaResponse getSchemaResponse;
        if (Flags.enableBatchPutVisibilityDocuments()) {
            getSchemaResponse =
     ...
     *
     * <p>Android V overlay {@link VisibilityToDocumentConverter#ANDROID_V_OVERLAY_SCHEMA} contains
     * public acl and visible to config.
     */
