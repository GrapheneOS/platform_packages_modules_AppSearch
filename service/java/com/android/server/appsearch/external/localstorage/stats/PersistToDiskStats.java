 ...
 *
 * <p>This class captures various latency metrics and status codes related to the process of
 * persisting data from AppSearch's in-memory state to disk.
 *
 * @hide
 */
public class PersistToDiskStats extends BaseStats {
    ...
    public static class Builder extends BaseStats.Builder<PersistToDiskStats.Builder> {
         ...
         *
         * @param packageName The package name associated with the persist operation. Can be {@code
         *     null}.
        ...
        @CanIgnoreReturnValue
        public @NonNull Builder setNativeIndexPersistLatencyMillis(int indexPersistLatencyMillis) {
