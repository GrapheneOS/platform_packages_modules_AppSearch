...
public final class SetSchemaStats extends BaseStats {
     ...
     *
     * <p>A join index-incompatible type change is one that affects how pre-existing document join
     * data should be searched over, such as modifying the {@code AppSearchSchema
    ...
    public static class Builder extends BaseStats.Builder<SetSchemaStats.Builder> {
        ...
        @SchemaMigrationStats.SchemaMigrationCallType int mSchemaMigrationCallType;
