...
public final class SearchStats {
    ...
    public static class Builder {
        ...
        @CanIgnoreReturnValue
        public @NonNull Builder setNativeNumEmbeddingShardsRead(int nativeNumEmbeddingShardsRead) {
        ...
        @CanIgnoreReturnValue
        public @NonNull Builder setNativeNumEmbeddingBytesRead(long nativeNumEmbeddingBytesRead) {
