...
public final class AppSearchAccount extends GenericDocument {
    ...
    public static final AppSearchSchema SCHEMA =
            new AppSearchSchema.Builder(SCHEMA_TYPE)
                    .addProperty(
                            new AppSearchSchema.StringPropertyConfig.Builder(PROPERTY_ACCOUNT_TYPE)
                                    .setCardinality(
                                    ...
                                    .build())
                    .addProperty(
                            new AppSearchSchema.StringPropertyConfig.Builder(PROPERTY_ACCOUNT_NAME)
                                    .setCardinality(
                                            AppSearchSchema.PropertyConfig.CARDINALITY_OPTIONAL)
                                    .setTokenizerType(
                                            AppSearchSchema.StringPropertyConfig
                                    ...
                                    .build())
                    .addProperty(
                            new AppSearchSchema.StringPropertyConfig.Builder(PROPERTY_ACCOUNT_ID)
                                    .setCardinality(
                                            AppSearchSchema.PropertyConfig.CARDINALITY_OPTIONAL)
                                    .setTokenizerType(
                                            AppSearchSchema.StringPropertyConfig
    ...
    /**
     * Creates a new {@link AppSearchAccount} from the contents of an existing {@link
     * GenericDocument}.
     *
