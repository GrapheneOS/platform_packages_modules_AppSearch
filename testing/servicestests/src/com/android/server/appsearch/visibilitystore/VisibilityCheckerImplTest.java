...
public class VisibilityCheckerImplTest {
    ...
    public void testIsSchemaSearchableByCaller_packageAccessibilityHandlesNameNotFoundException()
        ...
        // Grant package access
        mVisibilityStore.setVisibility(
                ImmutableList.of(visibilityConfig1), /* callStatsBuilder= */ null);
    ...
    @Test
    @RequiresFlagsDisabled(FLAG_ENABLE_APP_FUNCTION_AGENT_ALLOWLIST_CHECK)
    ...
    @Test
    @RequiresFlagsEnabled(FLAG_ENABLE_APP_FUNCTION_AGENT_ALLOWLIST_CHECK)
    ...
    public void testSetSchema_visibleToConfig_needMatchAllSettings() throws Exception {
        ...
        SchemaVisibilityConfig visibleToConfig =
                new SchemaVisibilityConfig.Builder()
                        .addAllowedPackage(new PackageIdentifier(packageNameFoo, sha256CertFoo))
                        .addRequiredPermissions(ImmutableSet.of(SetSchemaRequest.READ_SMS))
                        .build();
        InternalVisibilityConfig visibilityConfig =
                new InternalVisibilityConfig.Builder(/* id= */ prefix + "Schema")
    ...
    public void testSetSchema_enterpriseVisibleToConfig_withEnterpriseAccessPermission()
        ...
        SchemaVisibilityConfig visibleToConfig =
                new SchemaVisibilityConfig.Builder()
                        .addAllowedPackage(new PackageIdentifier(packageNameFoo, sha256CertFoo))
                        .addRequiredPermissions(ImmutableSet.of(ENTERPRISE_ACCESS))
                        .build();
        InternalVisibilityConfig visibilityConfig =
                new InternalVisibilityConfig.Builder(/* id= */ prefix + "Schema")
                        .addVisibleToConfig(visibleToConfig)
    ...
    public void testPublicVisibility_mockPackageManager() throws Exception {
        ...
        mVisibilityStore.setVisibility(visibilityConfigs, /* callStatsBuilder= */ null);
