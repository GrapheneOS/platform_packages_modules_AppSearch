    ...
    public void testBuilder() {
        ...
        String expectedString =
                "SearchSessionStats {\n"
                        ...
                        + "      timestampMillis=1,\n"
                        + "      numResultsFetched=2,\n"
                        + "      queryCorrectionType=1,\n"
                        + "      clicksStats=[\n"
                        + "        ClickStats {\n"
                        + "          timestampMillis=10,\n"
                        + "          timeStayOnResultMillis=20,\n"
                        + "          resultRankInBlock=30,\n"
                        + "          resultRankGlobal=40,\n"
                        + "          isGoodClick=false\n"
                        + "          enabledFeatures=0,\n"
                        ...
                        + "        ClickStats {\n"
                        + "          timestampMillis=11,\n"
                        + "          timeStayOnResultMillis=21,\n"
                        + "          resultRankInBlock=31,\n"
                        + "          resultRankGlobal=41,\n"
                        + "          isGoodClick=true\n"
                        + "          enabledFeatures=0,\n"
                        + "          javaLockAcquisitionLatencyMillis=-1,\n"
                        ...
                        + "      timestampMillis=2,\n"
                        + "      numResultsFetched=4,\n"
                        + "      queryCorrectionType=2,\n"
                        + "      clicksStats=[\n"
                        + "        ClickStats {\n"
                        + "          timestampMillis=12,\n"
                        + "          timeStayOnResultMillis=22,\n"
                        + "          resultRankInBlock=32,\n"
                        + "          resultRankGlobal=42,\n"
                        + "          isGoodClick=true\n"
                        + "          enabledFeatures=0,\n"
                        + "          javaLockAcquisitionLatencyMillis=-1,\n"
                        ...
                        + "  numIcingCalls=0\n"
                        + "}";
        assertThat(searchSessionStats.toString()).isEqualTo(expectedString);
    }
