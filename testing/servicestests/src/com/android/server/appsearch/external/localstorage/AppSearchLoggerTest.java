...
import com.android.server.appsearch.icing.proto.SetSchemaStatsProto;
...
public class AppSearchLoggerTest {
    ...
    public void testAppSearchLoggerHelper_testCopyNativeStats_setSchema() {
        ...
        ImmutableList<String> scorablePropertyCacheIncompatibleChangeeList =
                ImmutableList.of("index2");
        ...
        SetSchemaResultProto setSchemaResultProto =
                SetSchemaResultProto.newBuilder()
                        ...
                        .setSetSchemaStats(
                                SetSchemaStatsProto.newBuilder()
                                        .setSchemaStoreSetSchemaLatencyMs(
        ...
        assertThat(sStats.getJoinIndexIncompatibleTypeChangeCount())
                .isEqualTo(joinIndexIncompatibleChangeList.size());
        assertThat(sStats.getScorablePropertyIncompatibleTypeChangeCount())
                .isEqualTo(scorablePropertyCacheIncompatibleChangeeList.size());
    ...
    public void testLoggingStats_search_join() throws Exception {
        AppSearchSchema actionSchema =
                new AppSearchSchema.Builder("ViewAction")
                        .addProperty(
                                new AppSearchSchema.StringPropertyConfig.Builder("entityId")
                                        .setCardinality(
                                                AppSearchSchema.PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setIndexingType(
                                                AppSearchSchema.StringPropertyConfig
        ...
        AppSearchSchema entitySchema =
                new AppSearchSchema.Builder("entity")
                        .addProperty(
                                new AppSearchSchema.StringPropertyConfig.Builder("subject")
                                        .setCardinality(
                                                AppSearchSchema.PropertyConfig.CARDINALITY_OPTIONAL)
        ...
        GenericDocument action1 =
                new GenericDocument.Builder<>("namespace", "action1", "ViewAction")
                        .setPropertyString("entityId", "testPackage$testDatabase/namespace#id1")
                        .build();
        ...
        GenericDocument action4 =
                new GenericDocument.Builder<>("namespace", "action4", "ViewAction")
                        .setPropertyString("entityId", "testPackage$testDatabase/namespace#id2")
                        .build();
