...
public class AppSearchImplTest {
    ...
    public void testResetWithSchemaDatabaseMigration() throws Exception {
        ...
        SchemaProto existingSchema =
                mAppSearchImpl.getSchemaProtoLocked(/* callStatsBuilder= */ null);
    ...
    public void testQueryInvalidPackages_withJoin() throws Exception {
        ...
        List<AppSearchSchema> personAndCallSchema =
                ImmutableList.of(
                        new AppSearchSchema.Builder("personSchema").build(),
                        new AppSearchSchema.Builder("callSchema").addProperty(personField).build());
        InternalSetSchemaResponse internalSetSchemaResponse =
                mAppSearchImpl.setSchema(
                        "package1",
        ...
        // Insert package1 document
        GenericDocument person =
                new GenericDocument.Builder<>("namespace", "person", "personSchema").build();
        mAppSearchImpl.putDocument(
                "package1",
                "database1",
                person,
        ...
        GenericDocument call1 =
                new GenericDocument.Builder<>("namespace", "id1", "callSchema")
                        .setPropertyString("personId", "package1$database1/namespace#person")
                        .build();
        GenericDocument call2 =
                new GenericDocument.Builder<>("namespace", "id2", "callSchema")
                        .setPropertyString("personId", "package1$database1/namespace#person")
                        .build();
    ...
    public void testRemovePendingBlob() throws Exception {
        ...
        mAppSearchImpl.removeBlob("package", "db1", handle, /* callStatsBuilder= */ null);
    ...
    public void testRemoveBlobVisibility() throws Exception {
        ...
        String prefix = PrefixUtil.createPrefix("package", "db1");
        mAppSearchImpl.setBlobNamespaceVisibility(
                "package", "db1", ImmutableList.of(config1, config2), /* callStatsBuilder= */ null);
                ...
                assertThrows(
                        ...
                        () ->
                                mAppSearchImpl.globalOpenReadBlob(
                                        handle, mSelfCallerAccess, /* callStatsBuilder= */ null));
        assertThat(exception)
                .hasMessageThat()
                .contains(
                        Features.SCHEMA_BLOB_HANDLE
    ...
    public void testGlobalReadBlob() throws Exception {
        ...
        try (ParcelFileDescriptor writePfd =
                        mAppSearchImpl.openWriteBlob(
                                "package", "db1", visibleHandle, /* callStatsBuilder= */ null);
                OutputStream outputStream =
                        new ParcelFileDescriptor.AutoCloseOutputStream(writePfd)) {
            outputStream.write(data);
            outputStream.flush();
        }
        mAppSearchImpl.commitBlob("package", "db1", visibleHandle, /* callStatsBuilder= */ null);
        ...
        try (ParcelFileDescriptor writePfd =
                        mAppSearchImpl.openWriteBlob(
                                "package", "db1", nonVisibleHandle, /* callStatsBuilder= */ null);
                OutputStream outputStream =
                        new ParcelFileDescriptor.AutoCloseOutputStream(writePfd)) {
            outputStream.write(data);
            outputStream.flush();
        }
        mAppSearchImpl.commitBlob("package", "db1", nonVisibleHandle, /* callStatsBuilder= */ null);

        // visibleHandle is visible to the caller.
        byte[] readBytes = new byte[20 * 1024];
        try (ParcelFileDescriptor readPfd =
                        mAppSearchImpl.globalOpenReadBlob(
                                visibleHandle, mSelfCallerAccess, /* callStatsBuilder= */ null);
                InputStream inputStream = new ParcelFileDescriptor.AutoCloseInputStream(readPfd)) {
            inputStream.read(readBytes);
        }
        assertThat(readBytes).isEqualTo(data);
    ...
    public void testGlobalReadBlob_sameErrorMessage() throws Exception {
        ...
        mAppSearchImpl.removeBlob("package", "db1", visibleHandle, /* callStatsBuilder= */ null);
    ...
    public void testGetStorageInfoForDatabase_nonexistentPackage() throws Exception {
        ...
        StorageInfo storageInfo =
                mAppSearchImpl.getStorageInfoForDatabase(
                        "nonexistent.package", "nonexistentDatabase", /* callStatsBuilder= */ null);
        assertThat(storageInfo.getSizeBytes()).isEqualTo(0);
        assertThat(storageInfo.getAliveDocumentsCount()).isEqualTo(0);
        assertThat(storageInfo.getAliveNamespacesCount()).isEqualTo(0);
    }
    ...
    public void testGetStorageInfoForDatabase_nonexistentDatabase() throws Exception {
        ...
        StorageInfo storageInfo =
                mAppSearchImpl.getStorageInfoForDatabase(
                        "package1", "nonexistentDatabase", /* callStatsBuilder= */ null);
        assertThat(storageInfo.getSizeBytes()).isEqualTo(0);
        assertThat(storageInfo.getAliveDocumentsCount()).isEqualTo(0);
        assertThat(storageInfo.getAliveNamespacesCount()).isEqualTo(0);
    }
    ...
    public void testGetStorageInfoForDatabase_withoutDocument() throws Exception {
        ...
        StorageInfo storageInfo =
                mAppSearchImpl.getStorageInfoForDatabase(
                        "package1", "database1", /* callStatsBuilder= */ null);
        assertThat(storageInfo.getSizeBytes()).isEqualTo(0);
        assertThat(storageInfo.getAliveDocumentsCount()).isEqualTo(0);
        assertThat(storageInfo.getAliveNamespacesCount()).isEqualTo(0);
    }
    ...
    public void testGetStorageInfoForDatabase_proportionalToDocuments() throws Exception {
        ...
        storageInfo =
                mAppSearchImpl.getStorageInfoForDatabase(
                        "package1", "database2", /* callStatsBuilder= */ null);
        long size2 = storageInfo.getSizeBytes();
        assertThat(size2).isGreaterThan(0);
        assertThat(storageInfo.getAliveDocumentsCount()).isEqualTo(2);
        assertThat(storageInfo.getAliveNamespacesCount()).isEqualTo(1);
    ...
    public void testGetStorageInfoForPackages_withBlob() throws Exception {
        ...
        ParcelFileDescriptor writePfd1 =
                mAppSearchImpl.openWriteBlob(
                        "package1", "db1", handle1, /* callStatsBuilder= */ null);
        try (OutputStream outputStream =
        ...
        ParcelFileDescriptor writePfd2 =
                mAppSearchImpl.openWriteBlob(
                        "package1", "db1", handle2, /* callStatsBuilder= */ null);
        try (OutputStream outputStream =
        ...
        ParcelFileDescriptor writePfd3 =
                mAppSearchImpl.openWriteBlob(
                        "package2", "db1", handle3, /* callStatsBuilder= */ null);
        try (OutputStream outputStream =
    ...
    public void testGetStorageInfoForDatabase_withBlob() throws Exception {
        ...
        ParcelFileDescriptor writePfd1 =
                mAppSearchImpl.openWriteBlob(
                        "package", "db1", handle1, /* callStatsBuilder= */ null);
        try (OutputStream outputStream =
                new ParcelFileDescriptor.AutoCloseOutputStream(writePfd1)) {
            outputStream.write(data1);
            outputStream.flush();
        ...
        ParcelFileDescriptor writePfd2 =
                mAppSearchImpl.openWriteBlob(
                        "package", "db1", handle2, /* callStatsBuilder= */ null);
        try (OutputStream outputStream =
                new ParcelFileDescriptor.AutoCloseOutputStream(writePfd2)) {
            outputStream.write(data2);
            outputStream.flush();
        ...
        ParcelFileDescriptor writePfd3 =
                mAppSearchImpl.openWriteBlob(
                        "package", "db2", handle3, /* callStatsBuilder= */ null);
        try (OutputStream outputStream =
                new ParcelFileDescriptor.AutoCloseOutputStream(writePfd3)) {
            outputStream.write(data3);
            outputStream.flush();
        ...
        StorageInfo storageInfo1 =
                mAppSearchImpl.getStorageInfoForDatabase(
                        "package", "db1", /* callStatsBuilder= */ null);
        assertThat(storageInfo1.getBlobsSizeBytes()).isEqualTo(15 * 1024);
        assertThat(storageInfo1.getBlobsCount()).isEqualTo(2);
        StorageInfo storageInfo2 =
                mAppSearchImpl.getStorageInfoForDatabase(
                        "package", "db2", /* callStatsBuilder= */ null);
        assertThat(storageInfo2.getBlobsSizeBytes()).isEqualTo(20 * 1024);
        assertThat(storageInfo2.getBlobsCount()).isEqualTo(1);
    }
    ...
    public void testThrowsExceptionIfClosed() throws Exception {
        ...
        assertThrows(
                ...
                () ->
                        mAppSearchImpl.getStorageInfoForDatabase(
                                "package", "database", /* callStatsBuilder= */ null));
    ...
    public void testGetIcingSearchEngineStorageInfo() throws Exception {
        ...
        StorageInfoProto storageInfo =
                mAppSearchImpl.getRawStorageInfoProto(/* callStatsBuilder= */ null);
        ...
        AppSearchLogger fakeLogger =
                new AppSearchLogger() {
                    ...
                    public void logStats(@NonNull PersistToDiskStats stats) {
                        ...
                        assertThat(stats.getTriggerCallType())
                                .isEqualTo(BaseStats.CALL_TYPE_PUT_DOCUMENTS);
    ...
    public void testLimitConfig_activeWriteFds() throws Exception {
        ...
        AppSearchException e =
                assertThrows(
                        ...
                        () ->
                                mAppSearchImpl.openWriteBlob(
                                        "package", "db1", handle3, /* callStatsBuilder= */ null));
    ...
    public void testLimitConfig_activeReadFds() throws Exception {
        ...
        mAppSearchImpl.commitBlob(
                mContext.getPackageName(), "db1", handle, /* callStatsBuilder= */ null);
    ...
    public void testGetSchema_global_publicAcl() throws Exception {
        ...
        Map<String, Set<String>> packageCanSee =
                ImmutableMap.of(
                        "A", ImmutableSet.of("A"),
    ...
    public void testPutDocument_verifyAccount() throws Exception {
        ...
        mAppSearchImpl.updateAccountStore(
                /* allExistingAccounts= */ ImmutableSet.of(),
    ...
    public void testBatchPutDocument_verifyAccount() throws Exception {
        ...
        assertThat(result1.getErrorMessage())
                .containsMatch("The account at 0 of account doesn't exist");
        AppSearchResult<?> result2 = batchResult.getAll().get("id2");
        assertFalse(result2.isSuccess());
        assertThat(result2.getErrorMessage())
                .containsMatch("The account at 0 of account doesn't exist");
    }
    ...
    public void testWipeoutAccount_remove() throws Exception {
        ...
        mAppSearchImpl.updateAccountStore(
                ImmutableSet.of(account), /* renamedAccounts= */ ImmutableMap.of());
    ...
    public void testWipeoutAccount_rename() throws Exception {
        ...
        mAppSearchImpl.updateAccountStore(
                ImmutableSet.of(renamedAccount), ImmutableMap.of(account, renamedAccount));
        outDocument =
                mAppSearchImpl.getDocument(
                        "package",
                        "database",
    ...
    @Test
    public void testGetAndResetNeedPersistToDisk_returnsFalseForSameSetSchema() throws Exception {
        // Set schema
        List<AppSearchSchema> schemas =
                Collections.singletonList(
                        new AppSearchSchema.Builder("Type")
    ...
    @Test
    public void testGetAndResetNeedPersistToDisk_returnsTrueAfterPut() throws Exception {
        // Set schema
        List<AppSearchSchema> schemas =
                Collections.singletonList(
                        new AppSearchSchema.Builder("Type")
    ...
    @Test
    public void testGetAndResetNeedPersistToDisk_returnsTrueAfterRemove() throws Exception {
        // Set schema
        List<AppSearchSchema> schemas =
                Collections.singletonList(
                        new AppSearchSchema.Builder("Type")
    ...
    @Test
    public void testGetAndResetNeedPersistToDisk_returnsTrueAfterRemoveByQuery() throws Exception {
        // Set schema
        List<AppSearchSchema> schemas =
                Collections.singletonList(
                        new AppSearchSchema.Builder("Type")
