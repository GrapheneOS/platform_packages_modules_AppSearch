...
public class SchemaUtilTest {
    ...
    @Before
    public void setUp() {
        AppSearchSchema locationSchema =
                new AppSearchSchema.Builder(SCHEMA_TYPE_LOCATION)
                        .addProperty(
                                new AppSearchSchema.StringPropertyConfig.Builder("latitude")
                                        .setIndexingType(
                                        ...
                                        .build())
                        .addProperty(
                                new AppSearchSchema.StringPropertyConfig.Builder("longitude")
                                        .setIndexingType(
                                                AppSearchSchema.StringPropertyConfig
                                                        .INDEXING_TYPE_NONE)
                                        .setTokenizerType(
        ...
        mAddressSchema =
                new AppSearchSchema.Builder(SCHEMA_TYPE_ADDRESS)
                        .addProperty(
                                new AppSearchSchema.StringPropertyConfig.Builder("street")
                                        .setIndexingType(
                                                AppSearchSchema.StringPropertyConfig
                                                        .INDEXING_TYPE_NONE)
                                        .setTokenizerType(
                                        ...
                                        .build())
                        .addProperty(
                                new AppSearchSchema.LongPropertyConfig.Builder("zip_code").build())
                        .addProperty(
        ...
        mPersonSchema =
                new AppSearchSchema.Builder(SCHEMA_TYPE_PERSON)
                        .addProperty(
                ...
                assertThrows(
                        ...
                        () ->
                                SchemaUtil.verifyPropertyPathSchemaTypes(
                                        mSchemas, pathsToVerify, SCHEMA_TYPE_ADDRESS));

        assertThat(e)
                .hasMessageThat()
                .contains(
                        "The property path of: home_address.non_existent is not the required"
    ...
    public void testVerifyPropertyPathSchemaTypes_throwsOnWrongTargetType() {
        ...
        IllegalArgumentException e =
                assertThrows(
                        ...
                        () ->
                                SchemaUtil.verifyPropertyPathSchemaTypes(
                                        mSchemas, pathsToVerify, SCHEMA_TYPE_LOCATION));

        assertThat(e)
                .hasMessageThat()
                .contains(
                        "The property path of: home_address is not the required property type:"
                                + " LocationDetails");
    }
    ...
    public void testVerifyPropertyPathSchemaTypes_throwsWhenPathEndsAtLeafProperty() {
        ...
        assertThat(e)
                .hasMessageThat()
                .contains("The property path of: age is not the required property type: Address");
    }
}
