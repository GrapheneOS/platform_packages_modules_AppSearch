    ...
    public void testSearchResultBuilderCopyConstructor() {
        ...
        SearchResult searchResult =
                new SearchResult.Builder("package", "database")
                        ...
                        .addJoinedResult(
                                new SearchResult.Builder("pkg1", "db1")
                                        .setGenericDocument(document)
                                        .build())
                        .addJoinedResult(
                                new SearchResult.Builder("pkg2", "db2")
                                        .setGenericDocument(document)
                                        .build())
        ...
        assertThat(searchResultCopy.getGenericDocument())
                .isEqualTo(searchResult.getGenericDocument());
        ...
        assertThat(searchResultCopy.getJoinedResults().size())
                .isEqualTo(searchResult.getJoinedResults().size());
        ...
        assertThat(searchResultCopy.getMatchInfos().size())
                .isEqualTo(searchResult.getMatchInfos().size());
        assertThat(searchResultCopy.getMatchInfos().get(0).getPropertyPath())
                .isEqualTo("propertyPath1");
        assertThat(searchResultCopy.getMatchInfos().get(1).getPropertyPath())
                .isEqualTo("propertyPath2");
        assertThat(searchResultCopy.getMatchInfos().get(2).getPropertyPath())
                .isEqualTo("propertyPath3");
    }
    ...
    public void testSearchResultBuilder_clearJoinedResults() {
        ...
        SearchResult searchResult =
                new SearchResult.Builder("package", "database")
                        .setGenericDocument(document)
                        .addJoinedResult(
                                new SearchResult.Builder("pkg", "db")
                                        .setGenericDocument(document)
                                        .build())
                        .clearJoinedResults()
                        .build();
