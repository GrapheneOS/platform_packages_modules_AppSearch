...
public class SearchSpecInternalTest {
    ...
    public void testSearchSpecBuilder() {
        ...
        assertThat(searchSpec.getFilterNamespaces()).containsExactly("namespace1", "namespace2");
        assertThat(searchSpec.getFilterSchemas()).containsExactly("schemaTypes1", "schemaTypes2");
        assertThat(searchSpec.getFilterPackageNames()).containsExactly("package1", "package2");
    ...
    public void testSearchSpecBuilderCopyConstructor() {
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .setPropertyWeights(
                                "schemaTypes1", ImmutableMap.of("path1", 1.0, "path2", 2.0))
                        .setSnippetCount(5)
                        .setSnippetCountPerProperty(10)
                        .setMaxSnippetSize(15)
                        .setResultCountPerPage(42)
        ...
        assertThat(searchSpecCopy.getFilterProperties())
                .isEqualTo(searchSpec.getFilterProperties());
